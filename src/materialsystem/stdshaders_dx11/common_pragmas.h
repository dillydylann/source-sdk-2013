...
//
//
// Shader Model 5 maps onto the existing Shader Model 3 code paths in this DX11 copy.
#if defined( SHADER_MODEL_VS_5_0 ) && !defined( SHADER_MODEL_VS_3_0 )
#define SHADER_MODEL_VS_3_0 1
#endif
#if defined( SHADER_MODEL_PS_5_0 ) && !defined( SHADER_MODEL_PS_3_0 )
#define SHADER_MODEL_PS_3_0 1
#endif
